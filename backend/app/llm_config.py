...
_p(
    ...
    description="Kimi / Moonshot China (Moonshot CN direct API)",
    signup_url="https://platform.moonshot.cn/",
    env_vars=("KIMI_API_KEY",),
    base_url="",
    base_url_env_var="KIMI_BASE_URL",
...
_p(
    ...
    description="Alibaba Cloud / DashScope (Qwen + multi-provider models)",
...
_p(
    ...
    description="Xiaomi MiMo (MiMo-V2 models — pro, omni, flash)",

...
_p(
    ...
    description="Z.AI / GLM (Zhipu AI direct API — Z4 / GLM-4 series)",
...
_p(
    ...
    description="Kilo Code (Kilo Gateway API — kilo.ai)",
...
_p(
    ...
    description="GMI Cloud (multi-model direct API — gmicloud.ai)",
...
_p(
    ...
    description="Stepfun (Step series models — platform.stepfun.com)",
...
_p(
    ...
    aliases=(),
    display_name="Novita",
    description="Novita AI (Variety of models — novita.ai)",
